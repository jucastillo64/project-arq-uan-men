...
SELECT * FROM situacion_academica_2018_2019.men_sa_2018_2019;
SELECT sede_codigo FROM situacion_academica_2018_2019.men_sa_2018_2019 ORDER BY sede_codigo DESC;

SELECT situacade_nombre, count(jornsitu_cantidad_hombre) as TotalHombres, count(jornsitu_cantidad_mujer) as TotalMujeres
FROM situacion_academica_2018_2019.men_sa_2018_2019
